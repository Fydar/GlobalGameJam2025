...
/// <summary>
/// A way for an Animator to inform the gameplay elements of the visual state via a boolean
/// </summary>
public abstract class AnimatorBooleanLabel : MonoBehaviour, ISerializationCallbackReceiver
{
    ...
    private void Start()
    {
        if (informAnimator != null)
        {
            ...
            {
                informAnimator.SetBool(propertyName, value);
            }
        }
    }
...
#if UNITY_EDITOR
    [CustomEditor(typeof(AnimatorBooleanLabel), true)]
    public class AnimatorBooleanLabelEditor : Editor
    {
